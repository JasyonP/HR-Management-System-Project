...
<body>
    <div class="modal fade" id="viewEmployee{{$empdoc->id}}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true" data-bs-backdrop="static">
        <div class="modal-dialog modal-dialog-centered custom-modal-editemp">
        <div class="modal-content">
            <div class="modal-header">
            <h1 class="modal-title fs-3" id="exampleModalLabel">View Employee</h1>
                    ...
                    <div class="col p-3 border border-5" >
                        ...
                        <div class="row">
                            ...
                            <div class="col">
                                ...
                                <input type="text" name="first_name" id="first_name" value="{{$empdoc->first_name}}" class="form-control" readonly>
                            </div>

                            <div class="col">
                                <label for="" class="d-flex justify-content-start">Last Name:</label>
                                <input type="text" name="last_name" id="last_name" value="{{$empdoc->last_name}}" class="form-control" readonly>
                            </div>
                        </div> 
                        ...
                        <div class="row mt-3">
                            <div class="col">
                                ...
                                <input type="text" name="date_of_birth" id="date_of_birth" value="{{$empdoc->date_of_birth}}" class="form-control" readonly>
                            </div>

                            <div class="col">
                                <label for="" class="d-flex justify-content-start">Gender:</label>
                                <input type="text" name="gender" id="gender" value="{{$empdoc->gender}}" class="form-control" readonly>
                            ...
                            <div class="col">
                                ...
                                <input type="text" name="phone_number" id="phone_number" value="{{$empdoc->phone_number}}" class="form-control" readonly>
                            </div>
                        </div>
                        ...
                        <div class="column mt-3">
                            ...
                            <div class="col">
                                ...
                                <input type="text" name="address" id="address" value="{{$empdoc->address}}" class="form-control" readonly>
                            </div>

                            <div class="col mt-3">
                                <label for="" class="d-flex justify-content-start">Email:</label>
                                <input type="email" name="email" id="email" value="{{$empdoc->email}}" class="form-control" readonly>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col p-3 border border-5" >
                        <div class="row">
                            ...
                            <div class="col">
                                ...
                                <input type="text" name="job_id" id="job_id" value="{{$empdoc->job->job_title}}" class="form-control" readonly>
                            ...
                            <div class="col">
                                ...
                                <input type="text" name="date_of_birth" id="date_of_birth" value="{{$empdoc->department->department_name}}" class="form-control" readonly>
                        ...
                        <div class="row mt-3">
                            ...
                            <div class="col">
                                ...
                                <input type="text" name="work_status" id="work_status" value="{{$empdoc->work_status}}" class="form-control" readonly>
                            ...
                            <div class="col">
                                ...
                                <input type="text" name="employment_status" id="employment_status" value="{{$empdoc->employment_status}}" class="form-control" readonly>
    ...
    {{-- 
                        ...
                        <h5 class="d-flex justify-content-start mt-3">Profile</h5>
