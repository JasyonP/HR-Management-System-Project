...
<body>
    <div class="modal fade" id="createJob" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true" data-bs-backdrop="static">
        <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
            <h1 class="modal-title fs-3" id="exampleModalLabel">New Job</h1>
                ...
                <div class="modal-body">
                        ...
                        <div class="col">
                            ...
                            <select class="form-select" name="rank_id" id="job_id" class="form-control"required>
                                ...
                                <option value="" disabled selected hidden>List of Ranks</option>
